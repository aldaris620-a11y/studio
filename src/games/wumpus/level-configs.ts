...
export const levelConfigs: LevelConfig[] = [
  // Narrative Chapter 1 (Levels 1-10)
  { level: 1, gridSize: 3, arrows: 0, wumpusCount: 1, pitCount: 1, batCount: 1, staticCount: 0, lockdownCount: 0, ghostCount: 0, wumpusMoveChance: 0 },
  { level: 2, gridSize: 3, arrows: 0, wumpusCount: 1, pitCount: 1, batCount: 2, staticCount: 0, lockdownCount: 0, ghostCount: 0, wumpusMoveChance: 0.1 },
  { level: 3, gridSize: 4, arrows: 0, wumpusCount: 1, pitCount: 2, batCount: 1, staticCount: 1, lockdownCount: 0, ghostCount: 0, wumpusMoveChance: 0.15 },
  { level: 4, gridSize: 4, arrows: 0, wumpusCount: 1, pitCount: 2, batCount: 2, staticCount: 1, lockdownCount: 1, ghostCount: 0, wumpusMoveChance: 0.2 },
  { level: 5, gridSize: 5, arrows: 0, wumpusCount: 1, pitCount: 2, batCount: 2, staticCount: 2, lockdownCount: 1, ghostCount: 1, wumpusMoveChance: 0.25 },
  { level: 6, gridSize: 5, arrows: 0, wumpusCount: 1, pitCount: 3, batCount: 3, staticCount: 2, lockdownCount: 2, ghostCount: 1, wumpusMoveChance: 0.3 },
  { level: 7, gridSize: 5, arrows: 0, wumpusCount: 1, pitCount: 3, batCount: 3, staticCount: 3, lockdownCount: 2, ghostCount: 2, wumpusMoveChance: 0.35 },
  { level: 8, gridSize: 6, arrows: 0, wumpusCount: 1, pitCount: 4, batCount: 3, staticCount: 3, lockdownCount: 3, ghostCount: 2, wumpusMoveChance: 0.4 },
  { level: 9, gridSize: 6, arrows: 0, wumpusCount: 1, pitCount: 4, batCount: 4, staticCount: 4, lockdownCount: 3, ghostCount: 3, wumpusMoveChance: 0.45 },
  { level: 10, gridSize: 7, arrows: 0, wumpusCount: 1, pitCount: 5, batCount: 4, staticCount: 4, lockdownCount: 4, ghostCount: 3, wumpusMoveChance: 0.5 },
