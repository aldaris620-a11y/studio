...
export const chapters: Chapter[] = [
    {
        ...
        enabled: true,
        summary: {
            title: "Informe Final del Capítulo 1",
            content: [
                "INFORME DEL EXTRACTOR 7: El 'fallo técnico' es una criatura biológica hostil, designada 'Activo 734', resultado de un experimento fallido con un suero regenerativo en un soldado llamado William 'Wumpus' Anderson. Los sistemas de la instalación (drones, bloqueos) no son fallos, sino contramedidas deliberadas controladas por una IA central para probar tanto a la criatura como al extractor.",
                "Aethelred Industries nos ha estado mintiendo. No estamos conteniendo un accidente, somos los sujetos de prueba en una evaluación de armas biológicas. El Jefe de Seguridad Vance intentó advertirnos antes de ser silenciado. Mi conclusión es clara: Aethelred es el verdadero monstruo. Debo descubrir hasta dónde llega esta conspiración."
            ]
        },
        missions: [
            {
                id: `mission-1`, level: 1, title: `Misión 1.1`, objective: "Obtén tu informe de misión inicial en el terminal de datos.",
                description: "Los detalles de esta misión están clasificados.", terminalRoom: 8,
            ...
            },
            {
                ...
                description: "Los detalles de esta misión están clasificados.", terminalRoom: 7,
            ...
            },
             {
                ...
                description: "Los detalles de esta misión están clasificados.", terminalRoom: 12,
            ...
            },
            {
                ...
                description: "Los detalles de esta misión están clasificados.", terminalRoom: 15,
            ...
            },
            {
                ...
                description: "Los detalles de esta misión están clasificados.", terminalRoom: 13,
            ...
            },
            {
                ...
                description: "Los detalles de esta misión están clasificados.", terminalRoom: 10,
            ...
            },
            {
                ...
                description: "Los detalles de esta misión están clasificados.", terminalRoom: 9,
            ...
            },
            {
                ...
                description: "Los detalles de esta misión están clasificados.", terminalRoom: 14,
            ...
            },
            {
                ...
                description: "Los detalles de esta misión están clasificados.", terminalRoom: 2,
            ...
            },
            {
                ...
                description: "Los detalles de esta misión están clasificados.", terminalRoom: 16,
